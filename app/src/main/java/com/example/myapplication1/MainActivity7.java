...
public class MainActivity7 extends View {
    ...
    public MainActivity7(Context context) {
        super(context);
        init();
    }

    //View是在.xml文件中声明的，则调用此构造函数
    public MainActivity7(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MainActivity7(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public MainActivity7(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
